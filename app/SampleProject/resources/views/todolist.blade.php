...
<body>
        ...
        <form action="post" method="post" id="todo_form">
          @csrf
          ...
          <div class="w-3/5 flex mb-10 m-auto">
            ...
            <button formaction="{{ route('todo.store') }}" class="cursor-pointer ml-5 shadow-md rounded-md font-semibold text-white text-base bg-blue-500 hover:bg-blue-700 ring-2">
